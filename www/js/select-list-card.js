...
function e(e, t, s, i) {
  var n,
    r = arguments.length,
    o =
      r < 3 ? t : null === i ? (i = Object.getOwnPropertyDescriptor(t, s)) : i;
  if ("object" == typeof Reflect && "function" == typeof Reflect.decorate)
    o = Reflect.decorate(e, t, s, i);
  else
    for (var a = e.length - 1; a >= 0; a--)
      (n = e[a]) && (o = (r < 3 ? n(o) : r > 3 ? n(t, s, o) : n(t, s)) || o);
        ...
        if ((d++, 1 === e.nodeType)) {
          if (e.hasAttributes()) {
            const t = e.attributes,
              { length: s } = t;
            let i = 0;
            for (let e = 0; e < s; e++) a(t[e].name, "$lit$") && i++;
            for (; i-- > 0; ) {
              const t = p[u],
                s = h.exec(t)[2],
                i = s.toLowerCase() + "$lit$",
          ...
          if (t.indexOf(i) >= 0) {
            ...
            "" === n[o] ? (i.insertBefore(c(), e), s.push(e)) : (e.data = n[o]),
              (u += o);
          }
        } else if (8 === e.nodeType)
          if (e.data === i) {
            const t = e.parentNode;
            (null !== e.previousSibling && d !== l) ||
              (d++, t.insertBefore(c(), e)),
              (l = d),
              this.parts.push({ type: "node", index: d }),
              null === e.nextSibling ? (e.data = "") : (s.push(e), d--),
              u++;
          } else {
            let t = -1;
  ...
  for (; n.nextNode(); ) {
    ...
    for (
      e.previousSibling === h && (h = null),
        t.has(e) && (c.push(e), null === h && (h = e)),
        null !== h && l++;
      void 0 !== o && o.index === a;

    )
      (o.index = null !== h ? -1 : o.index - l), (r = p(i, r)), (o = i[r]);
  }
  ...
  getHTML() {
    ...
    for (let r = 0; r < e; r++) {
      const e = this.strings[r],
        o = e.lastIndexOf("\x3c!--");
      s = (o > -1 || s) && -1 === e.indexOf("--\x3e", o + 1);
      const a = h.exec(e);
      t +=
        null === a
          ? e + (s ? v : n)
          : e.substr(0, a.index) + a[1] + a[2] + "$lit$" + a[3] + i;
    }
...
class x {
  ...
  _getValue() {
    ...
    for (let i = 0; i < t; i++) {
      ...
      if (void 0 !== t) {
        const e = t.value;
        if (w(e) || !S(e)) s += "string" == typeof e ? e : String(e);
 ...
 */ function O(e) {
  ...
  return (
    (s = t.keyString.get(n)),
    void 0 === s &&
      ((s = new o(e, e.getTemplateElement())), t.keyString.set(n, s)),
...
(class {
  handleAttributeExpressions(e, t, s, i) {
    ...
    if ("@" === n) return [new $(e, t.slice(1), i.eventContext)];
    if ("?" === n) return [new C(e, t.slice(1), s)];
    return new x(e, t, s).parts;
  }
...
const Y = (e) => (t) => {
    ...
    if (((r = n.keyString.get(a)), void 0 === r)) {
      ...
      U && window.ShadyCSS.prepareTemplateDom(s, e),
        (r = new o(t, s)),
        n.keyString.set(a, r);
    }
...
const I = {
  ...
  F = (e, t) => t !== e && (t == t || e == e),
  L = { attribute: !0, type: String, converter: I, reflect: !1, hasChanged: F };
class W extends HTMLElement {
  ...
  static _valueHasChanged(e, t, s = F) {
    return s(e, t);
  }
  ...
  static _propertyValueToAttribute(e, t) {
    ...
    const s = t.type,
      i = t.converter;
    return ((i && i.toAttribute) || I.toAttribute)(e, s);
  }
  initialize() {
  ...
  _propertyToAttribute(e, t, s = L) {
    const i = this.constructor,
      n = i._attributeNameForProperty(e, s);
    if (void 0 !== n) {
  ...
  (ie.render = (e, t, i) => {
    ...
    if (
      (((e, t, i) => {
        ...
        void 0 === n &&
          (s(t, t.firstChild),
          A.set(t, (n = new P(Object.assign({ templateFactory: O }, i)))),
          n.appendInto(t)),
          n.setValue(e),
          n.commit();
      })(e, l, Object.assign({ templateFactory: Y(n) }, i)),
      a)
    ) {
      const e = A.get(l);
      A.delete(l);
      const i = e.value instanceof y ? e.value.template : void 0;
      q(n, l, i), s(t, t.firstChild), t.appendChild(l), A.set(t, e);
    }
    !r && o && window.ShadyCSS.styleElement(t.host);
  });
var ne = /d{1,4}|M{1,4}|YY(?:YY)?|S{1,3}|Do|ZZ|Z|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g,
  re = "[^\\s]+",
  oe = /\[([^]*?)\]/gm;
function ae(e, t) {
  for (var s = [], i = 0, n = e.length; i < n; i++) s.push(e[i].substr(0, t));
  return s;
}
var le = function (e) {
  return function (t, s) {
...
var he = [
  ...
  fe = {
    ...
    YY: function (e) {
      return me(String(e.getFullYear()), 4).substr(2);
    },
    YYYY: function (e) {
    ...
    mm: function (e) {
      return me(e.getMinutes());
    },
    s: function (e) {
      return String(e.getSeconds());
    },
    ss: function (e) {
      return me(e.getSeconds());
    },
    S: function (e) {
      return String(Math.round(e.getMilliseconds() / 100));
    },
    SS: function (e) {
      return me(Math.round(e.getMilliseconds() / 10), 2);
    },
    SSS: function (e) {
    ...
    ZZ: function (e) {
      ...
      return (
        (t > 0 ? "-" : "+") +
        me(100 * Math.floor(Math.abs(t) / 60) + (Math.abs(t) % 60), 4)
      );
    },
    Z: function (e) {
      var t = e.getTimezoneOffset();
  ...
  be = [
    ...
    function (e, t) {
      var s = e.toLowerCase();
      return s === t.amPm[0] ? 0 : s === t.amPm[1] ? 1 : null;
    },
  ],
  we = [
    "timezoneOffset",
...
var xe = function (e, t, s) {
  if (
    (void 0 === t && (t = Se.default),
    void 0 === s && (s = {}),
  ...
  var i = [];
  t = (t = Se[t] || t).replace(oe, function (e, t) {
    return i.push(t), "@@@";
  });
  var n = ce(ce({}, ge), s);
  return (t = t.replace(ne, function (t) {
    return fe[t](e, n);
  })).replace(/@@@/g, function () {
    return i.shift();
  });
...
function Ce(e, t) {
  ...
  switch (e) {
    ...
    default:
      return (
        console.warn("Unable to find icon for domain " + e + " (" + t + ")"), ke
      );
  }
}
var Ne = {
  ...
  Te = {
    ...
    cover: function (e) {
      ...
      switch (e.attributes.device_class) {
        ...
        default:
          return Ce("cover", e.state);
      }
    },
    sensor: function (e) {
      var t = e.attributes.device_class;
      if (t && t in Ne) return Ne[t];
      if ("battery" === t) {
        var s = Number(e.state);
        if (isNaN(s)) return "hass:battery-unknown";
        var i = 10 * Math.round(s / 10);
        return i >= 100
          ? "hass:battery"
          : i <= 0
          ? "hass:battery-alert"
      ...
      var n = e.attributes.unit_of_measurement;
      return "°C" === n || "°F" === n ? "hass:thermometer" : Ce("sensor");
    },
  ...
  Me = function (e) {
    ...
    return t in Te ? Te[t](e) : Ce(t, e.state);
  },
  $e = {
    version: "Version",
  ...
  Oe = {
    ...
    show_toggle: "Show toggle in header",
    scroll_to_selected: "Selected option always in view",
  },
  Ve = { common: $e, error: Ee, editor: Oe },
  Ae = {
    version: "Versión",
    name: "Seleccionar tarjeta de la lista",
    description:
      "Mostrar las opciones de una entidad input_select como una tarjeta de lista en la que se puede hacer clic.",
  },
  De = {
  ...
  je = {
    ...
    icon: "Icono (opcional)",
    max_options: "Número de opciones mostradas (0 = todas)",
    truncate: "Truncar el nombre de la opción larga",
    show_toggle: "Mostrar boton deslizante en la cabecera",
    scroll_to_selected: "Opción seleccionada siempre a la vista",
  },
  ze = { common: Ae, error: De, editor: je },
  Ue = {
    version: "Verzió",
    name: "Select list card",
    description:
      "Az input_select megjelenítése mint egy gördíthető, kattintható lista.",
  },
  Ye = {
    missing_entity: "Entitás megadása kötelező",
    invalid_configuration: "Hibás konfiguráció",
    not_available: "Az entitás nem elérhető",
  },
  Re = {
    entity: "Entitás (kötelező)",
    title: "Kártya címe (opcionális)",
    icon: "Ikon (opcionális)",
    max_options: "Megjelenített sorok száma (0 = összes)",
    truncate: "Sor hosszának levágása egységes szélesség érdekében",
    show_toggle: "Kapcsoló megjelenítése a fejlécben",
    scroll_to_selected: "Előreugrás a kijelölt sorra",
  },
  He = { common: Ue, error: Ye, editor: Re },
  qe = {
    version: "Versie",
  ...
  Fe = {
    ...
    show_toggle: "Toon toggle in titel",
    scroll_to_selected: "Geselecteerde optie altijd zichtbaar",
  },
  Le = { common: qe, error: Ie, editor: Fe };
const We = {
  en: Object.freeze({
    __proto__: null,
    common: $e,
...
function Be(e, t = "", s = "") {
  const i = e.split(".")[0],
    n = e.split(".")[1],
    r = (localStorage.getItem("selectedLanguage") || "en")
      .replace(/['"]+/g, "")
      .replace("-", "_");
  let o;
  try {
...
let Je = class extends ie {
  ...
  get _truncate() {
    return (this._config && this._config.truncate) || !0;
  }
  get _scroll_to_selected() {
    return (this._config && this._config.scroll_to_selected) || !0;
  }
  get _show_toggle() {
    return (this._config && this._config.show_toggle) || !1;
  }
  get _max_options() {
    return this._config && void 0 !== this._config.max_options
  ...
  render() {
    ...
    const e = Object.keys(this.hass.states).filter(
      (e) => "input_select" === e.substr(0, e.indexOf("."))
    );
    return j`
        ...
        <div class="values">
          <div class="row">
            <paper-dropdown-menu
              ...
              .configValue=${"entity"}
            >
              <paper-listbox slot="dropdown-content" .selected=${e.indexOf(
                this._entity
              )}>
                ${e.map(
                  (e) => j`
          ...
          <div class="row">
            <div class="side-by-side">
              ...
              >
                ${
                  this._icon || Me(this.hass.states[this._entity])
                    ? j`
                      <ha-icon .icon=${
                        this._icon || Me(this.hass.states[this._entity])
                      } slot="suffix">
          ...
          <div class="row">
            <ha-switch
              aria-label=${
                "Toggle scroll to selected " +
                (this._scroll_to_selected ? "off" : "on")
              }
          ...
          <div class="row">
            <ha-switch
              aria-label=${
                "Toggle show toggle " + (this._show_toggle ? "off" : "on")
              }
  ...
  _valueChanged(e) {
    ...
    const t = e.target,
      s = "max_options" === t.configValue ? parseInt(t.value) : t.value;
    if (this["_" + t.configValue] === s) return;
    const i = ["entity", "title", "icon"];
    t.configValue &&
      ("" !== s || i.includes(t.configValue)
        ? (this._config = Object.assign(Object.assign({}, this._config), {
            [t.configValue]: void 0 !== t.checked ? t.checked : s,
          }))
...
e([Z()], Je.prototype, "hass", void 0),
  e([Z()], Je.prototype, "_config", void 0),
  (Je = e([B("select-list-card-editor")], Je));
var Ze;
console.info(
  `%c  select-list-card \n%c  ${Be("common.version")} 1.2.0    `,
  ...
  window.customCards.push({
    ...
    name: "" + Be("common.name"),
    description: "" + Be("common.description"),
    preview: !0,
  });
let Ke = (Ze = class extends ie {
  constructor() {
    super(...arguments), (this.open = !0), (this.options = []);
  }
  static async getConfigElement() {
    return document.createElement("select-list-card-editor");
  }
  static getStubConfig(e, t) {
    return {
      entity: t.find((e) => e.startsWith("input_select")) || "",
      icon: "",
      truncate: !0,
      show_toggle: !1,
  ...
  setConfig(e) {
    if (!e || !e.entity || !e.entity.startsWith("input_select"))
      throw new Error(Be("error.invalid_configuration"));
    e.test_gui &&
      (function () {
  ...
  async getCardSize() {
    let e = 0;
    return this.config
      ? ((e += this.config.title ? 1 : 0),
        (e += this.config.max_options
          ? this.config.max_options
          : this.options.length),
        e)
      : e;
  }
  shouldUpdate(e) {
    return (function (e, t, s) {
      if (t.has("config") || s) return !0;
      if (e.config.entity) {
        var i = t.get("hass");
        return (
          !i || i.states[e.config.entity] !== e.hass.states[e.config.entity]
        );
      }
      return !1;
    })(this, e, !1);
  ...
  render() {
    if (!this.config.entity) return this.showError();
    const e = this.stateObj,
      t = e.state;
    this.options = e.attributes.options;
    const s =
      0 === this.config.max_options
        ? ""
        : `max-height: ${48 * (this.config.max_options || 5) + 16}px`;
    return j`
              ...
              >
                ...
                ${
                  this.config.show_toggle
                    ? j`
                      <ha-icon class="pointer" .icon="${
                        this.open ? "mdi:chevron-up" : "mdi:chevron-down"
                      }"></ha-icon>
                    `
                    : ""
                }
  ...
  toggle() {
    if (this.config.show_toggle && ((this.open = !this.open), this.open)) {
      const e = this.listEl.querySelector(".iron-selected");
      e &&
        setTimeout(() => {
          this.setScrollTop(e.offsetTop);
        }, 100);
    }
  }
  setScrollTop(e) {
    this.config.scroll_to_selected &&
      (this.listEl.scrollTop = e - (this.listEl.offsetTop + 8));
  }
  async selectedOptionChanged(e) {
    const t = e.detail.item.innerText.trim(),
      s = this.stateObj.state;
    e.detail && e.detail.item && this.setScrollTop(e.detail.item.offsetTop),
      t !== s &&
        (await Ze.setInputSelectOption(this.hass, this.config.entity, t));
  }
  static setInputSelectOption(e, t, s) {
...
var Ge;
e([Z()], Ke.prototype, "hass", void 0),
  e([Z()], Ke.prototype, "config", void 0),
  e([Z()], Ke.prototype, "open", void 0),
  e(
    [
      ((Ge = "#list"),
      (e, t) => {
        const s = {
          get() {
            return this.renderRoot.querySelector(Ge);
          },
          enumerable: !0,
          configurable: !0,
        };
        return void 0 !== t ? K(s, e, t) : G(s, e);
      }),
    ],
    Ke.prototype,
    "listEl",
  ...
  (Ke = Ze = e([B("select-list-card")], Ke));
export { Ke as SelectListCard };
